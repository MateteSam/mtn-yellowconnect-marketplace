    ...
    <div className="bg-background text-on-surface min-h-screen flex flex-col">
      ...
      <main className="container mx-auto px-container-margin-mobile py-8 max-w-2xl">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-on-surface-variant mb-6">Health-wellness Specialist (ID: {id})</p>
        ...
        <p className="mt-8 text-on-surface-variant text-center">Expert health-wellness services available for immediate booking via MTN MoMo.</p>
